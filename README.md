...
```bash
curl -fsSL https://raw.githubusercontent.com/krishnagutta/workday-community-mcp/v1.0/bin/quickstart.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/krishnagutta/workday-community-mcp/v1.0/bin/quickstart.sh | bash -s -- --no-playwright --no-desktop
```
